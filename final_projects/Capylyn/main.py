...
class TelegramBot:
    TOKEN: Final = "6854707293:AAHOq34Cz2yh0pzC10JWa8lGf7rC25u-3Xw"
    BOT_USERNAME: Final = "@finalfundamentals_bot"
    ...
    async def help_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        await update.message.reply_text(
            'I am a bot that provides you with top-5 tracks of your favorite artist in Spotify!')
    ...
    def get_weather_info(self, city_name):
        api_key = "df124684c67eaf4fa31b5298a570299b"
...
if __name__ == '__main__':
    TOKEN = "6854707293:AAHOq34Cz2yh0pzC10JWa8lGf7rC25u-3Xw"
    BOT_USERNAME = "@finalfundamentals_bot"

...
py_zen = """The Zen of Python, by Tim Peters
...
a, b, c, = 'better', 'never', 'is'

count_a = py_zen.count(a)
count_b = py_zen.count(b)
count_c = py_zen.count(c)

print(count_a, '   "better"')
print(count_b, '   "never"')
print(count_c, '   "is"')

#3

py_zen_up = py_zen.upper()
print(py_zen_up)

#4

py_zen_replace = py_zen.replace('i', '&')
print(py_zen_replace)

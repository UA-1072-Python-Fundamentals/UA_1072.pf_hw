file_contents = '''The Zen of Python, by Tim Peters
...
occ_better = file_contents.count("better")
occ_never = file_contents.count("never")
occ_is = file_contents.count("is")

# Output number of occurrences
print(f"Number of occurrences of the word 'better': {occ_better}")
print(f"Number of occurrences of the word 'never': {occ_never}")
print(f"Number of occurrences of the word 'is': {occ_is}")

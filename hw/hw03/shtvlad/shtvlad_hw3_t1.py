# str_zen ="""1.Beautiful is better than ugly.
...
# """
#FIND AND COUNT
# print("Number of occurrences of the words in the Python's philosophy list:")
# print("better =", str_zen.count("better"))
# print("never =", str_zen.count("never"))
# print("is =", str_zen.count("is"))

#TEXT IN UPPER
# print(str_zen.upper())

#REPLACE
#print(str_zen.replace("i","&"))

#PRODUCT OF DIGITS
# num=input("Input 4-digit number:\n")
# prod = int(num[0])*int(num[1])*int(num[2])*int(num[-1])
...
#SORTED
# num=input("Input 4-digit number:\n")
# sort = "".join(sorted(num,reverse=False))
# print("Product of the digits = ",sort)

#INTERCHANGE
a=10
b=30
print("Before interchanging a =",a, ", b=",b)
a,b=b,a
print("After interchanging a =",a, ", b=",b)
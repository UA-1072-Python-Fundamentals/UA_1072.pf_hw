...
w2 = "never"
w3 = "is"
print("The number of occurrences of the word 'better' is:", zen.count(w1))
print("The number of occurrences of the word 'never' is:", zen.count(w2))
print("The number of occurrences of the word 'is' is:", zen.count(w3))
# Task 1.1
print(zen.upper())
# Task 1.2
zen = zen.replace("i", "&")
...
# Task 2.0
st = "9238"
print('1st digit = ', st[0], ', 2nd digit = ', st[1], ', 3rd digit = ', st[2], ', 4th digit = ', st[3])
# Task 2.1
print("Reversed number is: ", st[::-1])
# Task 2.2
tate_list = list(st)
tate_list_sorted = sorted(tate_list)
print(tate_list_sorted)
# Task 3.0
d = [233, 'nadia', 'john']
c = True
d, c = c, d
print('d and c are:', d,',', c)

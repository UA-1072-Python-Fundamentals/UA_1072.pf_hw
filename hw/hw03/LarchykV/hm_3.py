...
#Task1.1
print("I've found this amount of \"better\":")
print("result: ", zen.count("better"))

print("I've found this amount of \"never\":")
print("result: ", zen.count("never"))

print("I've found this amount of \"is\":")
print("result: ", zen.count("is"))
...
#Task2.1
number  = str(input("Enter a 4-digit natural number: "))
product = int(number[0])*int(number[1])*int(number[2])*int(number[-1])

print("The product would be:", product )


#Task2.2

reversed_number = int(number[::-1])
print("The reversed number would be:", reversed_number)

#Task2.3
sorted_number = "".join(sorted(number))
print("The number in the ascending order would be:", sorted_number)

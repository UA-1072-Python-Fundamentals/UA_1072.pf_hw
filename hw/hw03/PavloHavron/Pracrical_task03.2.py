#TASK 3.01
a = ("""1.Beautiful is better than ugly.
...
print(a.replace("i", "&").upper())
print("The number of occurrences of the word 'better' is ", a.count("better"))
print("The number of occurrences of the word 'never' is ", a.count("never"))
print("The number of occurrences of the word 'is' is ", a.count("is"))
